...
<div id="header-div">
	...
	<div id="submenu-div">
		...
		<div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
			<a href="index.php?p=admin&c=Login&a=clear" target="_top" class="fix-submenu">清除缓存</a>
			<a href="index.php?p=admin&c=Login&a=logout" target="_top" class="fix-submenu">退出</a>
		</div>
	</div>
</div>
</body>
