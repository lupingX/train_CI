	 ...
	 <table width="100%" id="general-table">
		<tbody>
			...
			<tr>
				...
				<td>
					<select name="parent_id">
						...
						<?php echo str_repeat("&nbsp;", $ca['level']) ;?>
						<?php echo $ca['cat_name'] ;?></option>
			...
			<tr>
				...
				<td><input type="radio" name="is_show" value="1" checked="<?php echo $cat['is_show'] ;?>"> 是<input type="radio" name="is_show" value="0" checked="<?php echo 1-$cat['is_show'] ;?>"> 否  </td>
			</tr>
			<tr>
				<td class="label">是否显示在导航栏:</td>
				<td><input type="radio" name="show_in_nav" value="1" checked="<?php echo $cat['is_show'] ;?>"> 是  <input type="radio" name="show_in_nav" value="0" checked="<?php echo 1-$cat['is_show'] ;?>"> 否    </td>
			</tr>
			<tr>
